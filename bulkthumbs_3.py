...
+ need elegant solution for determining the username, whether or not its from the inputs or the desservices file
...
TO TEST:
+ Multiple tiles.
+ Make sure it properly converts either a COADD csv or RA,DEC csv to a pandas dataframe.

SUGGESTED COMMAND:
mpirun -n 4 python bulkthumbs_3.py --csv des0210-1624_100_coadds_sample.csv --make_tiffs --make_fits --xsize 3 --ysize 2 --colors g,r,i --usernm lgelman2

TESTS:
Options: time mpirun -n 1 python bulkthumbs_3.py --csv des0210-1624_100_sample.csv --make_tiff --make_fits --xsize 1 --ysize 1 --colors g,r,i,z,y --usernm lgelman2
1 core: real 0m31s, user 0m3s, sys 0m1s
2 cores: 

Options: time mpirun -n 6 python bulkthumbs_3.py --csv des_tiles_sample_1200_coadds.csv --make_tiffs --make_fits --xsize 1 --ysize 1 --colors g,r,i,z,y --usernm lgelman2
...
Options: time mpirun -n 6 python bulkthumbs_3.py --csv des_tiles_sample_12000_coadds.csv --make_tiffs --make_fits --xsize 1 --ysize 1 --colors g,r,i,z,y --usernm lgelman2
